...
public class ChinaBank extends Bank {
    ...
    public int getLimitOfWithdrawal() {
        switch (ChinaBank.this.getCurrency().toString()){
    ...
    public int getCommission(int summ) {
        if (ChinaBank.this.getCurrency().toString()=="USA" && summ <= 1000)commision = 3;
        else if (ChinaBank.this.getCurrency().toString()=="USA" && summ > 1000)commision = 5;
        else if (ChinaBank.this.getCurrency().toString()=="EUR" && summ <= 1000)commision = 10;
        else if (ChinaBank.this.getCurrency().toString()=="EUR" && summ > 1000)commision = 11;
        return commision;
    }
