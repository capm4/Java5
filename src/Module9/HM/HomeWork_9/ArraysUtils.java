...
public class ArraysUtils {
    ...
    public List<Order> sortByItemIdenAndCity(List<Order> a){
    ...
    public List<Order> delDublicate (List<Order> a){
        a.stream()
    ...
    public  List<Order> delPrize1500 (List<Order> a){
    ...
    public  List<Order> sortUSDandUAH(List<Order> a){
    ...
    public List<Order> listOfCity (List<Order> a){
    ...
    public List<Order> orderPetrov (List<Order> a){
    ...
    public  List<Order> delUSD (List<Order> a) {
